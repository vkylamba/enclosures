...
RJ_45_BOTTOM_OFFSET = 11.5
RJ45_FROM_RIGHT = 10.5
...
LCD_MODULE_OUTER_W = 80 + 2 * WALL_THICKNESS + 1  # 80mm PCB + 2x1.5mm bezel
LCD_MODULE_OUTER_H = 36 + 2 * WALL_THICKNESS + 1  # 36mm PCB + 2x1.5mm bezel
LCD_MODULE_HEIGHT = 8.5 + WALL_THICKNESS  # 8.5mm PCB + 1.5mm bezel + 1mm clearance
